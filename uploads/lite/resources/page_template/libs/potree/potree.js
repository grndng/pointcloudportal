...
initSidebar = (viewer) => {
	...
	function initClassificationList () {
		...
		addClassificationItem(0, 'Nie klassifiziert');
		addClassificationItem(1, 'Unklassifiziert');
		addClassificationItem(2, 'Bodenpunkte');
		addClassificationItem(3, 'Flache Vegetation');
		addClassificationItem(4, 'Mittelhohe Vegetation');
		addClassificationItem(5, 'Hohe Vegetation');
		addClassificationItem(6, 'Gebäude');
		addClassificationItem(7, 'Rauschen');
		addClassificationItem(8, 'Schlüsselpunkte');
		addClassificationItem(9, 'Wasser');
		addClassificationItem(12, 'Überdeckung');
	}
...
/*
		...
		let elCameraProjection = $(`
			<selectgroup id="camera_projection_options">
				<option id="camera_projection_options_perspective" value="PERSPECTIVE">Perspektivisch</option>
				<option id="camera_projection_options_orthigraphic" value="ORTHOGRAPHIC">Orthographisch</option>
			</selectgroup>
		`);
	/*	elNavigation.append(elCameraProjection);
		elCameraProjection.selectgroup({title: "Projektion"});
	...
	let initSettings = function () {
...

		{
			...
			elSplatQuality.selectgroup({title: "Splat Qualität"});
